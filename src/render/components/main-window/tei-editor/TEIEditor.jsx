...
import {
  transformPastedHTMLHandler,
  transformPastedHandler,
  createClipboardSerializer,
} from "../../../model/cut-and-paste";
import {
  navigateFromTreeToEditor,
  getSelectedElements,
  broadcastZoneLinks,
  navigateFromEditorToTree,
  getEditorCommands,
  arrowNavToNote,
} from "../../../model/editor-navigation";
...
export default class TEIEditor extends Component {
  ...
  createEditorView = (element) => {
    ...
    this.clipboardSerializer = createClipboardSerializer(
      teiSchema,
      teiDocument
    );
  ...
  dispatchTransaction = (transaction) => {
    ...
    const { teiDocument, onAlertMessage, onErrorCountChange, onResetSearch } =
      this.props;
    ...
    if (editorView) {
      ...
      if (
        teiDocument.selectedElements.length === 0 &&
      ...
      this.setState({
        ...this.state,
        noteID: nextNoteID,
        notePopupAnchorEl: nextNotePopupAnchorEl,
      });
    }
  };
  ...
  getMainEditorHotKeyConfig() {
    ...
    const { keyMap, handlers } = getHotKeyConfig(
      teiDocument,
      getEditorCommands(
        teiDocument,
        this.onTogglePalette,
        this.onOpenElementMenu,
  ...
  render() {
    ...
    return (
      <main style={style} className="TEIEditor">
          ...
          <div>
            ...
            >
              ...
              <ProseMirrorComponent
                ...
                thumbMargin={true}
              />
              {!hidden && <ThumbnailMargin teiDocument={teiDocument} />}
            </div>
            {!hidden && (
              <ParameterDrawer
                teiDocument={teiDocument}
        ...
        {paletteWindowOpen && !readOnly && (
          <StructurePalette
            ...
            onClose={() => {
              this.setState({ ...this.state, paletteWindowOpen: false });
            }}
          ></StructurePalette>
        )}
      </main>
