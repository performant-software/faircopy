...
import { teiDataCountValidator } from '../../tei-document/attribute-validators'
...
export default class TEIDataNumericField extends Component {
    ...
    constructor(props) {
        ...
        this.state = value !== "" && value !== null ? teiDataCountValidator(value, minOccurs, maxOccurs) : {}
    }
    ...
    onChange = (e) => {
        ...
        if( value !== "" && value !== null ) {
            const validState = teiDataCountValidator(value, minOccurs, maxOccurs)
